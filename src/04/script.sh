...
printf "\nColumn 1 background = $(print_color_name "$1" "$5")\n"
printf "Column 1 font color = $(print_color_name "$2" "$5")\n"
printf "Column 2 background = $(print_color_name "$3" "$5")\n"
printf "Column 2 font color = $(print_color_name "$4" "$5")\n"